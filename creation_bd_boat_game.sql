...
--
-- Creation de l'utilisateur `BoatGame`
--

CREATE USER 'BoatGame'@'%' IDENTIFIED WITH caching_sha2_password BY '***';
GRANT USAGE ON *.* TO 'BoatGame'@'%';
ALTER USER 'BoatGame'@'%' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;
GRANT ALL PRIVILEGES ON `db\_boat\_game`.* TO 'BoatGame'@'%'; 